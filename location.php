                     ...
                     $select_all_posts_query = mysqli_query($connection,$query);
                        while ($row = mysqli_fetch_assoc($select_all_posts_query)) {
                            ...
                            while ($row = mysqli_fetch_assoc($select_location_id)) {
                                ...
                                ?>
                                <h4>Result For :  <?php echo "<td>{$location_title}</td>"?></h4>
                    ...
                    <div class="row mt-30">
                        ...
                        if(isset($_GET['location'])) {
                            ...
                            if (isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'admin') {
                                $query = "SELECT * FROM posts WHERE  post_location_id=$post_location_id  ORDER BY post_id DESC ";


                            } else {
                                $query = "SELECT * FROM posts WHERE  post_location_id=$post_location_id AND post_status='published'  ORDER BY post_id DESC ";
