<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.php"> Admin Dashboard <i class="fas  fa-user-circle"></i></a>
    </div>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav " >
            <li>
                <a href="index.php"><i class="fa fa-fw fa-chart-line"></i> Dashboard</a>
            </li>
            ...
            <li>
                ...
                <ul id="posts" class="collapse">
                    <li>
                        <a href="posts.php"> <i class="fas fa-eye"></i> View all Posts</a>
                    </li>
                    <li>
            ...
            <li>
                <a href="location.php"><i class="fa fa-fw fa-location-arrow"></i>  Locations</a>
            </li>
            ...
            <li>
                ...
                <ul id="demo" class="collapse">
                    ...
                    <li>
                        <a href="users.php?source=add_user"> <i class="fa fa-fw fa-user-plus"></i> Add user</a>
                    </li>
                </ul>
            </li>
